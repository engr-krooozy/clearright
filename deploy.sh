...
gcloud run deploy "${BACKEND_SERVICE}" \
  ...
  --cpu=1 \
  --timeout=3600 \
  --set-env-vars="APP_NAME=clearright,AGENT_VOICE=Aoede,GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_CLOUD_LOCATION=${REGION},GOOGLE_GENAI_USE_VERTEXAI=0,GOOGLE_API_KEY=${GOOGLE_API_KEY}" \
  --project="${PROJECT_ID}"
